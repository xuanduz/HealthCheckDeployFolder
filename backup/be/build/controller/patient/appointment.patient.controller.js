...
var _appointmentPatient = _interopRequireDefault(require("../../services/patient/appointment.patient.service"));
...
var booking = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _appointmentPatient["default"].booking(req.body);
        case 3:
  ...
  return function booking(_x, _x2) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _appointmentPatient["default"].verifyEmail(req.body);
        case 3:
...
var deleteBooking = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _appointmentPatient["default"].deleteBooking(req.params.id);
        case 3:
  ...
  return function deleteBooking(_x5, _x6) {
...
var bookingDirect = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _appointmentPatient["default"].bookingDirect(req.body);
        case 3:
  ...
  return function bookingDirect(_x7, _x8) {
...
var getHistoryPatient = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return _appointmentPatient["default"].getHistoryPatient(req.params.id);
        case 3:
  ...
  return function getHistoryPatient(_x9, _x10) {
