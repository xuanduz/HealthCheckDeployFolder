...
var _doctorPatient = _interopRequireDefault(require("../../services/patient/doctor.patient.service"));
...
var filterDoctor = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _doctorPatient["default"].filterDoctor(req.body);
        case 3:
  ...
  return function filterDoctor(_x, _x2) {
...
var filterFeaturedDoctor = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _doctorPatient["default"].filterFeaturedDoctor(req.body);
        case 3:
  ...
  return function filterFeaturedDoctor(_x3, _x4) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _doctorPatient["default"].getDoctor(req.params.id);
        case 3:
...
var getRelateDoctor = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _doctorPatient["default"].getRelateDoctor(req.params.id);
        case 3:
  ...
  return function getRelateDoctor(_x7, _x8) {
