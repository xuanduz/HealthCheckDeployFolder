...
var _require = require("sequelize"),
  Op = _require.Op;
var addNewSpecialty = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(specialtyData, file) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
              var imageUrl, newSpecialty;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 11:
                    newSpecialty = _context.sent;
                    resolve({
                      message: _label.Label.CREATE_SPECIALTY_SUCCESS,
                      success: true,
                      data: newSpecialty
                    });
                    _context.next = 19;
  ...
  return function addNewSpecialty(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var getSpecialty = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(specialtyId) {
  ...
  return function getSpecialty(_x5) {
    return _ref3.apply(this, arguments);
  };
}();
var filterSpecialty = /*#__PURE__*/function () {
        ...
        case 0:
          return _context6.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
              var pageNum, pageSize, specialtyName, _yield$db$Specialty$f, count, rows;
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  case 0:
                    _context5.prev = 0;
                    pageNum = filter.pageNum, pageSize = filter.pageSize, specialtyName = filter.specialtyName;
                    _context5.next = 4;
                    return _models["default"].Specialty.findAndCountAll({
                      offset: (+pageNum - 1) * +pageSize,
                      limit: +pageSize,
                      distinct: true,
                      where: {
                        name: _defineProperty({}, Op.like, "%".concat(specialtyName ? specialtyName : "", "%"))
                      }
                      // nest: true,
                    });
                  case 4:
                    _yield$db$Specialty$f = _context5.sent;
                    count = _yield$db$Specialty$f.count;
                    rows = _yield$db$Specialty$f.rows;
                    resolve({
                      message: _label.Label.SUCCESS,
                      success: true,
                      data: rows,
  ...
  return function filterSpecialty(_x8) {
    return _ref5.apply(this, arguments);
  };
}();
var editSpecialty = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(specialtyInfo, file) {
        ...
        case 0:
          return _context8.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(resolve, reject) {
              var specialty, imageUrl, oldUrl, newSpecialty;
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  ...
                  case 3:
                    specialty = _context7.sent;
                    if (specialty) {
                      _context7.next = 8;
                      break;
                    }
                    resolve({
                      message: _label.Label.NOT_EXISTED_SPECIALTY,
                      success: false
                    });
                    _context7.next = 25;
                    break;
                  ...
                  case 15:
                    ...
                    oldUrl = specialty.dataValues.image;
                    if (!oldUrl) {
                      _context7.next = 21;
                      break;
                    }
                  ...
                  case 21:
                    _context7.next = 23;
                    return specialty.update(_objectSpread(_objectSpread({}, specialtyInfo), {}, {
                      image: imageUrl
                    }));
                  case 23:
                    newSpecialty = _context7.sent;
                    resolve({
  ...
  return function editSpecialty(_x11, _x12) {
    return _ref7.apply(this, arguments);
  };
}();
var deleteSpecialty = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(specialtyId) {
  ...
  return function deleteSpecialty(_x15) {
