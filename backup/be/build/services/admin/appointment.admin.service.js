...
var _require = require("sequelize"),
  Op = _require.Op;
var getAppointmentDetail = /*#__PURE__*/function () {
                  ...
                  case 0:
                    ...
                    return _models["default"].Appointment.findOne({
                      ...
                      include: [{
                        ...
                        as: "doctorData",
                        attributes: {
                          exclude: ["createdAt", "updatedAt", "password", "accessToken", "refreshToken", "describe", "descriptionHTML"]
                        },
                        include: [{
  ...
  return function getAppointmentDetail(_x) {
    return _ref.apply(this, arguments);
  };
}();
var filterAppointment = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(filter) {
        ...
        case 0:
          return _context4.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
              var pageNum, pageSize, orderBy, patientName, provinceKey, statusKey, bookingType, date, _yield$db$Appointment, count, rows;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.prev = 0;
                    pageNum = filter.pageNum, pageSize = filter.pageSize, orderBy = filter.orderBy, patientName = filter.patientName, provinceKey = filter.provinceKey, statusKey = filter.statusKey, bookingType = filter.bookingType, date = filter.date;
                    _context3.next = 4;
                    return _models["default"].Appointment.findAndCountAll({
                      offset: (+pageNum - 1) * +pageSize,
                      limit: +pageSize,
                      distinct: true,
                      order: [["createdAt", orderBy || "DESC"]],
                      where: {
                        statusKey: _defineProperty({}, Op.like, "%".concat(statusKey ? statusKey : "", "%")),
                        date: _defineProperty({}, Op.like, "%".concat(date ? date : "", "%"))
                      },
                      include: [{
                        model: _models["default"].Patient,
                        as: "patientData",
                        where: {
                          fullName: _defineProperty({}, Op.like, "%".concat(patientName ? patientName : "", "%"))
                        },
                        attributes: {
                          exclude: ["createdAt", "updatedAt", "password", "accessToken", "refreshToken"]
                        },
                        ...
                        as: "statusData",
                        where: {
                          key: _defineProperty({}, Op.like, "%".concat(statusKey ? statusKey : "", "%"))
                        },
                        attributes: {
                          exclude: ["createdAt", "updatedAt"]
                        }
                        ...
                        as: "bookingData",
                        where: {
                          key: _defineProperty({}, Op.like, "%".concat(bookingType ? bookingType : "", "%"))
                        },
                        attributes: {
                          exclude: ["createdAt", "updatedAt"]
                        }
                  ...
                  case 4:
                    ...
                    count = _yield$db$Appointment.count;
                    rows = _yield$db$Appointment.rows;
                    resolve({
                      message: _label.Label.SUCCESS,
                      success: true,
                      data: rows,
  ...
  return function filterAppointment(_x4) {
    return _ref3.apply(this, arguments);
  };
}();
var editAppointment = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(appointmentInfo) {
        ...
        case 0:
          return _context6.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
              var appointment, patient, existedEmail, scheduleExist, newAppointment;
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  ...
                  case 3:
                    ...
                    if (!appointment) {
                      resolve({
                        message: _label.Label.NOT_EXISTED_APPOINTMENT,
                        success: false
                      });
                    }
                    _context5.next = 7;
                    return _models["default"].Patient.findOne({
                      where: {
                        id: appointmentInfo.patientData.id
                      }
                    });
                  case 7:
                  ...
                  case 12:
                    ...
                    return _models["default"].Patient.findOne({
                      where: {
                        ...
                        id: _defineProperty({}, Op.ne, appointmentInfo.patientData.id)
                      }
                    });
                  case 14:
                    existedEmail = _context5.sent;
                    if (!existedEmail) {
                      _context5.next = 19;
                      break;
                    }
                  ...
                  case 29:
                    _context5.next = 31;
                    return patient.update(appointmentInfo.patientData);
                  case 31:
                    _context5.next = 33;
                    return appointment.update(appointmentInfo);
                  case 33:
                    newAppointment = _context5.sent;
                    resolve({
  ...
  return function editAppointment(_x7) {
    return _ref5.apply(this, arguments);
  };
}();
var editStatus = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(appointmentInfo) {
  ...
  return function editStatus(_x10) {
    return _ref7.apply(this, arguments);
  };
}();
var deleteAppointment = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(appointmentId) {
        ...
        case 0:
          return _context10.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(resolve, reject) {
              var appointmentInfo, resultFile;
              return _regeneratorRuntime().wrap(function _callee9$(_context9) {
                while (1) switch (_context9.prev = _context9.next) {
                  ...
                  case 3:
                    appointmentInfo = _context9.sent;
                    resultFile = appointmentInfo.resultFile;
                    _context9.next = 7;
  ...
  return function deleteAppointment(_x13) {
