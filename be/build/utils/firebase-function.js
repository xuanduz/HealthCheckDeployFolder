...
exports.uploadImage = exports.uploadFile = exports.getPathStorageFromUrl = exports.deleteFile = void 0;
...
var getPathStorageFromUrl = function getPathStorageFromUrl(url) {
...
// Initialize Firebase
var appFirebase = (0, _app.initializeApp)(firebaseConfig);
        ...
        case 0:
          return _context3.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
              var newFileName, storageRef;
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    try {
                      newFileName = Date.now() + _path["default"].extname(file.originalname);
                      storageRef = (0, _storage.ref)(storage, "files/".concat(newFileName));
                      (0, _storage.uploadBytes)(storageRef, file.buffer).then( /*#__PURE__*/function () {
...
var deleteFile = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(oldUrl) {
        ...
        case 0:
          return _context5.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(resolve, reject) {
              var oldNameFile, desertRef;
              return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                while (1) switch (_context4.prev = _context4.next) {
                  case 0:
                    try {
                      oldNameFile = getPathStorageFromUrl(oldUrl);
                      desertRef = (0, _storage.ref)(storage, oldNameFile); // Delete the file
                      (0, _storage.deleteObject)(desertRef).then(function () {
                        resolve();
...
var uploadImage = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(file) {
              ...
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  case 0:
                    try {
                      newFileName = Date.now() + _path["default"].extname(file.originalname);
                      storageRef = (0, _storage.ref)(storage, "images/".concat(newFileName));
                      (0, _storage.uploadBytes)(storageRef, file.buffer).then( /*#__PURE__*/function () {
                        var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(snapshot) {
                          var url;
