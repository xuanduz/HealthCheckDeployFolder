...
var _emailPatient = require("./email.patient.service");
...
var resetToken = /*#__PURE__*/function () {
  ...
  return function resetToken(_x) {
    return _ref.apply(this, arguments);
  };
}();
var createNewAccount = /*#__PURE__*/function () {
        ...
        case 0:
          return _context3.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
              var accountExisted, response, hashedPassword;
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  ...
                  case 3:
                    ...
                    _context2.next = 8;
                    return _bcryptjs["default"].hashPassword(data.password);
                  case 8:
                    hashedPassword = _context2.sent;
                    _context2.next = 11;
                    return _models["default"].Patient.create({
                      email: data.email,
  ...
  return function createNewAccount(_x2) {
        ...
        case 0:
          return _context5.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(resolve, reject) {
              var account, result, comparePassword, token;
              return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                while (1) switch (_context4.prev = _context4.next) {
                  ...
                  case 3:
                    ...
                    _context4.next = 8;
                    return _bcryptjs["default"].comparePassword(data.password, account.password);
                  case 8:
                    ...
                    token = (0, _token.generateTokens)(account);
                    _context4.next = 13;
                    return _models["default"].Patient.update({
                  ...
                  case 13:
                    result = {
                      message: _label.Label.LOGIN_SUCCESS,
                      success: true,
                      accessToken: token.accessToken,
                      refreshToken: token.refreshToken
                    };
                  ...
                  case 16:
                    result = {
                      message: _label.Label.WRONG_PASSWORD_OR_EMAIL,
                      success: false
                    };
                  case 17:
                    _context4.next = 20;
            ...
            var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(resolve, reject) {
              ...
              return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                while (1) switch (_context6.prev = _context6.next) {
                  case 0:
                    _context6.prev = 0;
                    code = (0, _pagingData.getCodePassword)(6);
                    _context6.next = 4;
                    return _models["default"].Patient.update({
                      codePassword: code
                    }, {
                  ...
                  case 4:
                    _context6.next = 6;
                    return (0, _emailPatient.sendEmailToNewPass)({
                      email: data.email,
                      code: code
                    });
                  case 6:
                    resolve({
                      message: _label.Label.CHECK_EMAIL,
                      success: true
                    });
                    _context6.next = 12;
                    break;
...
var verifyCode = /*#__PURE__*/function () {
                ...
                while (1) switch (_context8.prev = _context8.next) {
                  ...
                  case 3:
                    ...
                    if (patient.dataValues.codePassword != data.codePassword) {
                      resolve({
                        message: _label.Label.WRONG_CODE,
                        success: false
                      });
                    } else {
                      resolve({
                        message: _label.Label.SUCCESS_CODE,
                        success: true
                      });
                    }
                    _context8.next = 10;
  ...
  return function verifyCode(_x11) {
...
var setNewPassword = /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee10$(_context10) {
                while (1) switch (_context10.prev = _context10.next) {
                  case 0:
                    _context10.prev = 0;
                    _context10.next = 3;
                    return _bcryptjs["default"].hashPassword(data.newPassword);
                  case 3:
                    hashedNewPassword = _context10.sent;
                    _context10.next = 6;
                    return _models["default"].Patient.update({
  ...
  return function setNewPassword(_x14) {
...
var logout = /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee12$(_context12) {
                while (1) switch (_context12.prev = _context12.next) {
                  ...
                  case 3:
                    ...
                    _context12.next = 6;
                    return resetToken(account.email);
                  case 6:
                    resolve({
                      success: true
                    });
  ...
  return function logout(_x17) {
    return _ref12.apply(this, arguments);
  };
}();
var updateRefreshToken = /*#__PURE__*/function () {
  var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(email, refreshToken) {
  ...
  return function updateRefreshToken(_x20, _x21) {
...
var getNewAccessToken = /*#__PURE__*/function () {
        ...
        case 0:
          return _context16.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref16 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(resolve, reject) {
              var refreshToken, account, tokens;
              return _regeneratorRuntime().wrap(function _callee15$(_context15) {
                while (1) switch (_context15.prev = _context15.next) {
                  ...
                  case 4:
                    ...
                    if ((0, _token.verifyRefreshToken)(refreshToken)) {
                      tokens = (0, _token.generateTokens)(account);
  ...
  return function getNewAccessToken(_x22, _x23) {
