...
var _specialtyAdmin = _interopRequireDefault(require("../../services/admin/specialty.admin.service"));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _specialtyAdmin["default"].addNewSpecialty(req.body, req.file);
        case 3:
...
var getSpecialty = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _specialtyAdmin["default"].getSpecialty(req.params.id);
        case 3:
  ...
  return function getSpecialty(_x3, _x4) {
...
var filterSpecialty = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _specialtyAdmin["default"].filterSpecialty(req.body);
        case 3:
  ...
  return function filterSpecialty(_x5, _x6) {
...
var editSpecialty = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _specialtyAdmin["default"].editSpecialty(req.body, req.file);
        case 3:
  ...
  return function editSpecialty(_x7, _x8) {
...
var deleteSpecialty = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return _specialtyAdmin["default"].deleteSpecialty(req.params.id);
        case 3:
  ...
  return function deleteSpecialty(_x9, _x10) {
